...
const LoginPage = ({ onLogin }) => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-100 via-slate-50 to-slate-100 p-6">
      ...
      >
        <h2 className="text-3xl font-semibold text-slate-900 mb-2">Admin Sign In</h2>
        <p className="text-slate-500 mb-6">Secure access for managers and HR administrators.</p>
